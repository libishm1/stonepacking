import { Quaternion, RotationEuler } from "../types";

export const BASE_RADIUS = 1;
export const DISCRETE_ROTATIONS: RotationEuler[] = [
  { x: 0, y: 0, z: 0 },
  { x: Math.PI / 2, y: 0, z: 0 },
  { x: -Math.PI / 2, y: 0, z: 0 },
  { x: Math.PI, y: 0, z: 0 },
...
export function rotationToQuaternion(rotation: RotationEuler): Quaternion {
...
export function computeRadius(scale: number): number {
